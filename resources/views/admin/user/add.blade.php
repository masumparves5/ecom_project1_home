            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="post" action="">
                        ...
                        <div class="row mb-4">
                            <label for="lastName" class="col-md-3 form-label">User Description</label>
                            <div class="col-md-9">
                                <textarea class="form-control" id="lastName" placeholder="User Description" type="text" name="description"></textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
