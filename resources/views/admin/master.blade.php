                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a href="{{route('category.manage')}}" class="slide-item">Manage Categroy</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            ...
                            <ul class="slide-menu">
                                <li><a href="{{route('subCategory.add')}}" class="slide-item">Add Sug-Category</a></li>
        ...
        <div class="container">
            <div class="row align-items-center flex-row-reverse">
                <div class="col-md-12 col-sm-12 text-center">
                    Copyright © 2024 <a href="#">Shopgrid</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="#"> Masum Parvs </a> All rights reserved
                </div>
            </div>
        </div>
    </footer>
