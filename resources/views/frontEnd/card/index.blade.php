                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-md-3 col-12">
                            <h5 class="product-name">
                                <a href="product-details.html">{{$cart_product->name}}</a>
                            </h5>
                            <p class="product-des">
                        ...
                        <div class="col-lg-1 col-md-2 col-12">
                            <a class="remove-item" href="{{route('cart.delete', ['row_id' => $cart_product->rowId])}}" onclick="return confirm('Are you sure to delete this')"><i class="lni lni-close"></i></a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    <ul>
                                        ...
                                        <li>Tax (15%)<span>{{$tax = round($sum * 0.15)}}</span></li>
                                        <li>Delivery Charge<span>{{$shipping = 100}}</span></li>
                                        <li class="last">You Pay<span>{{$sum + $tax + $shipping}}</span></li>
                                    </ul>
                                    <div class="button">
