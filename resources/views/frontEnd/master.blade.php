...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('/')}}frontEnd-assets/assets/images/favicon.svg" />

    <link rel="stylesheet" href="{{asset('/')}}frontEnd-assets/assets/css/bootstrap.min.css" />
    <link rel="stylesheet" href="{{asset('/')}}frontEnd-assets/assets/css/LineIcons.3.0.css" />
    <link rel="stylesheet" href="{{asset('/')}}frontEnd-assets/assets/css/tiny-slider.css" />
    <link rel="stylesheet" href="{{asset('/')}}frontEnd-assets/assets/css/glightbox.min.css" />
                ...
                <div class="row align-items-center">
                    <div class="col-lg-4 col-12">
                        <div class="payment-gateway">
                            <span>We Accept:</span>
                            <img src="{{asset('/')}}frontEnd-assets/assets/images/footer/credit-cards-footer.png" alt="#">
                        </div>
                    </div>
                    <div class="col-lg-4 col-12">
                        <div class="copyright">
...
<script src="{{asset('/')}}frontEnd-assets/assets/js/tiny-slider.js"></script>
<script src="{{asset('/')}}frontEnd-assets/assets/js/glightbox.min.js"></script>
